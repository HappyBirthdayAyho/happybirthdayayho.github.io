$(function() {
    ...
    let greetings = ["Цъкни тук", "Цъкни там", "Сега тук", "Сега там", "Ся тук","Ся там", "и тук", "и там", "ама и тук", "много бавно цъкаш", "баба ми цъка по-добре", "Мноо бавно", "harder", "better", "faster", "stronger"];
